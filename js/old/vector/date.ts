...
export class DateVector<T extends Date_ = Date_> extends BaseVector<T> {
    ...
    // public static from<T extends Date_, TNull = any>(input: Iterable<T['TValue'] | TNull>): V<T>;
    // public static from<T extends Date_, TNull = any>(input: AsyncIterable<T['TValue'] | TNull>): Promise<V<T>>;
