...
export interface ByteWidthVisitor extends Visitor {
    ...
    visit     <T extends DataType>(node: T, ...args: any[])                      : number;
    getVisitFn<T extends Type>    (node: T)         : (type: T, ...args: any[]) => number;
    getVisitFn<T extends DataType>(node: Vector<T>) : (type: T, ...args: any[]) => number;
    getVisitFn<T extends DataType>(node: Data<T>)   : (type: T, ...args: any[]) => number;
    getVisitFn<T extends DataType>(node: T)         : (type: T, ...args: any[]) => number;
}
